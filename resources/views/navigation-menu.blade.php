<nav x-data="{ open: false }" class="text-sm font-normal tracking-wider bg-white border-b border-gray-100 font-cool">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link href="{{ route('admin.brand.index') }}" :active="request()->routeIs('admin.br and.index')">
                {{ __('Brand') }}
            </x-responsive-nav-link>
        </div>
