<x-front-layout>
    ...
    <section class="bg-darkGrey relative py-[70px]">
      <div class="container">
        ...
        <div class="p-[30px] bg-white rounded-2xl max-w-[490px] w-full mb-5 flex flex-col gap-5">
            <h1 class="mx-auto font-bold text-center">DETAIL TRANSACTION</h1>
            <div>Car Name : {{ $item->name }}</div>
            <div>Price : ${{ number_format($item->price) }}/day</div>
        </div>
