<x-app-layout>
    ...
    <x-slot name="header">
      <h2 class="text-xl font-normal leading-tight tracking-wider text-gray-800 font-cool">
        ...
        Cars &raquo; Sunting &raquo; {{ $item->name }}
      </h2>
    </x-slot>
      ...
      <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div>
          ...
          <form class="w-full" action="{{ route('admin.item.update',$item->id) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="flex flex-wrap px-3 mt-4 mb-6 -mx-3">
              ...
              <select name="type_id" id="" required class="z-50 block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500">
                ...
                <option value="{{ $item->brand->id }}" selected>Belum Di Ganti ({{ $item->brand->name }})</option>
          ...
          <div class="w-full">
            ...
            <option value="{{ $item->type->id }}" selected>Belum Di Ganti ({{ $item->type->name }})</option>
            <option value="" disabled>-----------------------</option>
